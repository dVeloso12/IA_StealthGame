...
public class Maze2 : MonoBehaviour
{
   ...
   int currentCell = 0;
    ...
    [HideInInspector]
    public GameObject previousMaze,prevEnemy,prevTrigger;
    ...
    IEnumerator CreateWalls()           //Cria as paredes com base nas dimensões dadas pelo utilizador
    {
        ...
        initialPos = new Vector3((-xSize / 2) + wallLength / 2, 0.0f, (startPosY)+wallLength/2);  //Esta posição inicial obtem a parede mais "baixa" e mais "á esquerda" através do posição (0,0)
